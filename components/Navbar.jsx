  ...
  return (
    <div style={{backgroundColor: `${navBg}`}} className={shadow ? 'fixed w-full h-20 shadow-xl z-[100]' : 'fixed w-full h-20 z-[100]'}>
        <div className='flex justify-between items-center w-full h-full px-2 2xl:px-16'>
            <Link href='/'>
                <Image src='/final.png' alt='/' width='125' height='50' />
                {/* <Image src='/../public/assets/skills/namelogo.png' alt='/' width='125' height='50' /> */}
            </Link>
            <div>
            ...
            <div className={nav 
                ...
                <div>
                    <div className='flex w-full items-center justify-between'>
                        <Link href='/'>
                            <Image onClick={() => setNav(false)} src={'/mylogo.png'} width='87' height='35' alt='/' />
                        </Link>
                ...
                <div className='py-4 flex flex-col'>
                    ...
                    <div className='pt-40'>
                        ...
                        <div className='flex items-center justify-between my-4 w-full sm:w-[80%]'>
                            <div className='rounded-full shadow-lg shadow-gray-400 p-1.5 cursor-pointer hover:scale-105 ease-in duration-300'>
